...
@Metadata(m24mv = {1, 1, 16}, m25bv = {1, 0, 3}, m23k = 1, m26d1 = {"\ufffd\ufffd\u001c\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u0002\n\u0002\b\u0004\n\u0002\u0018\u0002\n\u0002\b\u0003\u0018\ufffd\ufffd2\u00020\u0001B\u0005\u00a2\u0006\u0002\u0010\u0002J\b\u0010\u0003\u001a\u00020\u0004H\u0016J\b\u0010\u0005\u001a\u00020\u0004H\u0016J\b\u0010\u0006\u001a\u00020\u0004H\u0016J\u0010\u0010\u0007\u001a\u00020\u00042\u0006\u0010\b\u001a\u00020\tH\u0016J\b\u0010\n\u001a\u00020\u0004H\u0016J\b\u0010\u000b\u001a\u00020\u0004H\u0016\u00a8\u0006\f"}, m27d2 = {"Lnet/ccbluex/liquidbounce/features/module/modules/movement/speeds/aquavit/HytNewSpeed;", "Lnet/ccbluex/liquidbounce/features/module/modules/movement/speeds/SpeedMode;", "()V", "onDisable", "", "onEnable", "onMotion", "onMove", "event", "Lnet/ccbluex/liquidbounce/event/MoveEvent;", "onTick", "onUpdate", LiquidBounce.CLIENT_NAME})
/* loaded from: L-out.jar:net/ccbluex/liquidbounce/features/module/modules/movement/speeds/aquavit/HytNewSpeed.class */
public final class HytNewSpeed extends SpeedMode {
    public HytNewSpeed() {
        super("HytNewSpeed");
    }
        ...
        if (MovementUtils.isMoving()) {
            ...
            if (!thePlayer4.getOnGround()) {
                ...
                if (r0.getFallDistance() <= 0.1d) {
                    ...
                    thePlayer5.setSpeedInAir(0.016f);
                    MinecraftInstance.f157mc.getTimer().setTimerSpeed(1.1f);
                }
            }
            if (MinecraftInstance.f157mc.getThePlayer() == null) {
                Intrinsics.throwNpe();
            ...
            if (r0.getFallDistance() > 0.1d) {
                ...
                if (r0.getFallDistance() < 1.3d) {
                    ...
                    thePlayer6.setSpeedInAir(0.016f);
                    MinecraftInstance.f157mc.getTimer().setTimerSpeed(0.5f);
                }
            }
            if (MinecraftInstance.f157mc.getThePlayer() == null) {
                Intrinsics.throwNpe();
