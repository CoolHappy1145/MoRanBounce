...
@Metadata(m24mv = {1, 1, 16}, m25bv = {1, 0, 3}, m23k = 1, m26d1 = {"\ufffd\ufffd,\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u0006\n\u0002\b\u0004\n\u0002\u0010\b\n\u0002\b\u0003\n\u0002\u0010\u0002\n\u0002\b\u0004\n\u0002\u0018\u0002\n\u0002\b\u0004\u0018\ufffd\ufffd2\u00020\u0001B\u0005\u00a2\u0006\u0002\u0010\u0002J\b\u0010\f\u001a\u00020\rH\u0016J\b\u0010\u000e\u001a\u00020\rH\u0016J\b\u0010\u000f\u001a\u00020\rH\u0016J\u0010\u0010\u0010\u001a\u00020\r2\u0006\u0010\u0011\u001a\u00020\u0012H\u0016J\b\u0010\u0013\u001a\u00020\rH\u0016J\u0010\u0010\u0014\u001a\u00020\u00042\u0006\u0010\u0015\u001a\u00020\u0004H\u0002R\u0014\u0010\u0003\u001a\u00020\u00048BX\u0082\u0004\u00a2\u0006\u0006\u001a\u0004\b\u0005\u0010\u0006R\u000e\u0010\u0007\u001a\u00020\u0004X\u0082\u000e\u00a2\u0006\u0002\n\ufffd\ufffdR\u000e\u0010\b\u001a\u00020\tX\u0082\u000e\u00a2\u0006\u0002\n\ufffd\ufffdR\u000e\u0010\n\u001a\u00020\u0004X\u0082\u000e\u00a2\u0006\u0002\n\ufffd\ufffdR\u000e\u0010\u000b\u001a\u00020\tX\u0082\u000e\u00a2\u0006\u0002\n\ufffd\ufffd\u00a8\u0006\u0016"}, m27d2 = {"Lnet/ccbluex/liquidbounce/features/module/modules/movement/speeds/ncp/NCPBHop;", "Lnet/ccbluex/liquidbounce/features/module/modules/movement/speeds/SpeedMode;", "()V", "baseMoveSpeed", "", "getBaseMoveSpeed", "()D", "lastDist", "level", "", "moveSpeed", "timerDelay", "onDisable", "", "onEnable", "onMotion", "onMove", "event", "Lnet/ccbluex/liquidbounce/event/MoveEvent;", "onUpdate", "round", PropertyDescriptor.VALUE, LiquidBounce.CLIENT_NAME})
/* loaded from: L-out.jar:net/ccbluex/liquidbounce/features/module/modules/movement/speeds/ncp/NCPBHop.class */
    ...
    */
    public void onEnable() {
        ...
        if (theWorld.getCollidingBoundingBoxes(iEntityPlayerSP, entityBoundingBox.offset(0.0d, thePlayer3.getMotionY(), 0.0d)).size() <= 0) {
            ...
            i = thePlayer4.isCollidedVertically() ? 1 : 4;
        }
        this.level = i;
    }
    ...
    */
    public void onMove(@NotNull MoveEvent event) {
        ...
        if (round(posY - ((int) r2.getPosY())) == round(0.138d)) {
            ...
            thePlayer5.setPosY(thePlayer5.getPosY() - 0.09316090325960147d);
        }
        if (this.level == 1) {
            ...
            if (thePlayer6.getMoveForward() == 0.0f) {
                IEntityPlayerSP thePlayer7 = MinecraftInstance.f157mc.getThePlayer();
                if (thePlayer7 == null) {
                    Intrinsics.throwNpe();
                }
                if (thePlayer7.getMoveStrafing() == 0.0f) {
                    if (this.level == 2) {
                        this.level = 3;
                        ...
                        thePlayer8.setMotionY(0.399399995803833d);
                        ...
                        IEntityPlayerSP iEntityPlayerSP = thePlayer9;
                        IEntityPlayerSP thePlayer10 = MinecraftInstance.f157mc.getThePlayer();
                        if (thePlayer10 == null) {
                            Intrinsics.throwNpe();
                        }
                        IAxisAlignedBB entityBoundingBox = thePlayer10.getEntityBoundingBox();
                        IEntityPlayerSP thePlayer11 = MinecraftInstance.f157mc.getThePlayer();
                        if (thePlayer11 == null) {
                            Intrinsics.throwNpe();
                        }
                        if (!(!theWorld.getCollidingBoundingBoxes(iEntityPlayerSP, entityBoundingBox.offset(0.0d, thePlayer11.getMotionY(), 0.0d)).isEmpty())) {
                            IEntityPlayerSP thePlayer12 = MinecraftInstance.f157mc.getThePlayer();
                            if (thePlayer12 == null) {
                                Intrinsics.throwNpe();
                            }
                            if (thePlayer12.isCollidedVertically()) {
                                this.level = 1;
                            }
        ...
        IMovementInput movementInput = thePlayer13.getMovementInput();
        ...
        thePlayer15.setStepHeight(0.6f);
        if (moveForward == 0.0f && moveStrafe == 0.0f) {
            event.setX(0.0d);
            event.setZ(0.0d);
        }
    ...
    private final double getBaseMoveSpeed() {
        ...
        if (thePlayer.isPotionActive(MinecraftInstance.classProvider.getPotionEnum(PotionType.MOVE_SPEED))) {
            ...
            amplifier = 0.2873d * (1.0d + (0.2d * r3.getAmplifier()) + 1.0d);
        }
        return amplifier;
    }
