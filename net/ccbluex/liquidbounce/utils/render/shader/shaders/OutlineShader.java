...
/* loaded from: L-out.jar:net/ccbluex/liquidbounce/utils/render/shader/shaders/OutlineShader.class */
public final class OutlineShader extends FramebufferShader {
    ...
    public void updateUniforms() {
        ...
        GL20.glUniform2f(getUniform("texelSize"), (1.0f / f157mc.getDisplayWidth()) * this.radius * this.quality, (1.0f / f157mc.getDisplayHeight()) * this.radius * this.quality);
