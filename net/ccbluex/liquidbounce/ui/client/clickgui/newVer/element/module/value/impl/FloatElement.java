...
public final class FloatElement extends ValueElement {
    ...
    public float drawElement(int i, int i2, float f, float f2, float f3, @NotNull Color bgColor, @NotNull Color accentColor) {
        ...
        float stringWidth = 30.0f + Fonts.font40.getStringWidth(String.valueOf(((int) this.savedValue.getMaximum()) + 0.01f));
        ...
        if (this.dragged) {
            this.savedValue.set((Object) Float.valueOf(RangesKt.coerceIn(round(this.savedValue.getMinimum() + (((this.savedValue.getMaximum() - this.savedValue.getMinimum()) / stringWidth4) * (i - f4))), this.savedValue.getMinimum(), this.savedValue.getMaximum())));
        }
        Fonts.font40.getStringWidth(String.valueOf(round(((Number) this.savedValue.get()).floatValue())));
        ...
        Fonts.font40.drawString(String.valueOf(round(((Number) this.savedValue.get()).floatValue())), ((f + f3) + 6.0f) - stringWidth, ((f2 + 10.0f) - (Fonts.font40.getFontHeight() / 2.0f)) + 2.0f, -1);
    ...
    public void onClick(int i, int i2, float f, float f2, float f3) {
        ...
        if (((float) i) >= ((f + f3) - 5.0f) - stringWidth && ((float) i) < ((f + f3) + 3.0f) - stringWidth && ((float) i2) >= f2 + 2.0f && ((float) i2) < f2 + 18.0f) {
            this.savedValue.set((Object) Float.valueOf(RangesKt.coerceIn(round(((Number) this.savedValue.get()).floatValue() - 0.01f), this.savedValue.getMinimum(), this.savedValue.getMaximum())));
        }
