...
public interface IGuiSlot extends IGui {
    ...
    void registerScrollButtons(int i, int i2);

    void drawScreen(int i, int i2, float f);

    void elementClicked(int i, boolean z, int i2, int i3);
