...
public final class WrappedListArrayAdapter implements IWrappedArray {
    ...
    public Object get(int i) {
        return this.wrapper.invoke(this.wrapped.get(i));
    }

    @Override // net.ccbluex.liquidbounce.api.util.IWrappedArray
    public void set(int i, Object obj) {
        this.wrapped.set(i, this.unwrapper.invoke(obj));
    }
