...
public final class ClientPrivateMessagePacket implements Packet {
    ...
    public static ClientPrivateMessagePacket copy$default(ClientPrivateMessagePacket clientPrivateMessagePacket, String str, User user, String str2, int i, Object obj) {
        if ((i & 1) != 0) {
            str = clientPrivateMessagePacket.f110id;
        }
        if ((i & 2) != 0) {
    ...
    public String toString() {
        return "ClientPrivateMessagePacket(id=" + this.f110id + ", user=" + this.user + ", content=" + this.content + ")";
    }
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        if (!(obj instanceof ClientPrivateMessagePacket)) {
            return false;
        }
        ClientPrivateMessagePacket clientPrivateMessagePacket = (ClientPrivateMessagePacket) obj;
        return Intrinsics.areEqual(this.f110id, clientPrivateMessagePacket.f110id) && Intrinsics.areEqual(this.user, clientPrivateMessagePacket.user) && Intrinsics.areEqual(this.content, clientPrivateMessagePacket.content);
    }
