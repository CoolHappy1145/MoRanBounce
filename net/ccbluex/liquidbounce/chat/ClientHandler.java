...
public final class ClientHandler extends SimpleChannelInboundHandler {
    ...
    public void handlerAdded(@NotNull ChannelHandlerContext ctx) {
        ...
        Intrinsics.checkExpressionValueIsNotNull(channelPromiseNewPromise, "ctx.newPromise()");
        this.handshakeFuture = channelPromiseNewPromise;
    }
    ...
    public void channelInactive(@NotNull ChannelHandlerContext ctx) {
        ...
        this.client.setChannel$LiquidSense((Channel) null);
    ...
    protected void channelRead0(@NotNull ChannelHandlerContext ctx, @NotNull Object msg) {
        ...
        if (!this.handshaker.isHandshakeComplete()) {
            try {
                ...
                channelPromise2.setFailure(e);
            }
            Client client = this.client;
            ChannelPromise channelPromise3 = this.handshakeFuture;
            if (channelPromise3 == null) {
                Intrinsics.throwUninitializedPropertyAccessException("handshakeFuture");
            }
            client.onHandshake(channelPromise3.isSuccess());
            return;
        }
        if (!(msg instanceof TextWebSocketFrame)) {
            ...
            String strText = ((TextWebSocketFrame) msg).text();
            Intrinsics.checkExpressionValueIsNotNull(strText, "msg.text()");
            client2.onMessage$LiquidSense(strText);
        }
    }
}
