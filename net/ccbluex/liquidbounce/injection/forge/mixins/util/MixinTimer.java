...
@Mixin({Timer.class})
/* loaded from: L-out.jar:net/ccbluex/liquidbounce/injection/forge/mixins/util/MixinTimer.class */
public class MixinTimer implements IMixinTimer {
    ...
    public void func_74275_a() {
        long jFunc_71386_F = Minecraft.func_71386_F();
        this.field_194148_c = ((jFunc_71386_F - this.field_74277_g) / this.field_194149_e) * this.timerSpeed;
        this.field_74277_g = jFunc_71386_F;
        this.field_194147_b += this.field_194148_c;
        this.field_74280_b = (int) this.field_194147_b;
        this.field_194147_b -= this.field_74280_b;
    }

    @Override // net.ccbluex.liquidbounce.injection.implementations.IMixinTimer
