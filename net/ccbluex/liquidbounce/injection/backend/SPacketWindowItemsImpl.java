...
public final class SPacketWindowItemsImpl extends PacketImpl implements ISPacketWindowItems {
    ...
    @Override // net.ccbluex.liquidbounce.api.minecraft.network.play.server.ISPacketWindowItems
    public int getWindowId() {
        return getWrapped().func_148911_c();
    }
}
