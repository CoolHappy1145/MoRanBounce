...
public final class EntityTNTPrimedImpl extends EntityImpl implements IEntityTNTPrimed {
    ...
    @Override // net.ccbluex.liquidbounce.api.minecraft.client.entity.IEntityTNTPrimed
    public int getFuse() {
        return getWrapped().func_184536_l();
    }
}
