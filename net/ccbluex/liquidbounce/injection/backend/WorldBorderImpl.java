...
public final class WorldBorderImpl implements IWorldBorder {
    ...
    @Override // net.ccbluex.liquidbounce.api.minecraft.world.border.IWorldBorder
    public boolean contains(@NotNull WBlockPos blockPos) {
        Intrinsics.checkParameterIsNotNull(blockPos, "blockPos");
        return this.wrapped.func_177746_a(new BlockPos(blockPos.getX(), blockPos.getY(), blockPos.getZ()));
    }

    public boolean equals(@Nullable Object obj) {
        return (obj instanceof WorldBorderImpl) && Intrinsics.areEqual(((WorldBorderImpl) obj).wrapped, this.wrapped);
    }
}
