...
/* loaded from: L-out.jar:net/ccbluex/liquidbounce/injection/backend/SPacketEntityImpl.class */
public final class SPacketEntityImpl extends PacketImpl implements ISPacketEntity {
    ...
    @Override // net.ccbluex.liquidbounce.api.minecraft.network.play.server.ISPacketEntity
    public boolean getOnGround() {
        return getWrapped().func_179742_g();
    }
    ...
    public IEntity getEntity(@NotNull IWorld world) {
        ...
        Entity entityFunc_149065_a = getWrapped().func_149065_a(((WorldImpl) world).getWrapped());
        if (entityFunc_149065_a != null) {
            return new EntityImpl(entityFunc_149065_a);
        }
        return null;
    }
}
