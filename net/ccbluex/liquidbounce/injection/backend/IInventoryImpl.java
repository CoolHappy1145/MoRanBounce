...
/* loaded from: L-out.jar:net/ccbluex/liquidbounce/injection/backend/IInventoryImpl.class */
public final class IInventoryImpl implements IIInventory {
    ...
    @Override // net.ccbluex.liquidbounce.api.minecraft.client.gui.inventory.IIInventory
    @NotNull
    public String getName() {
        String strFunc_70005_c_ = this.wrapped.func_70005_c_();
        Intrinsics.checkExpressionValueIsNotNull(strFunc_70005_c_, "wrapped.name");
        return strFunc_70005_c_;
    }

    public boolean equals(@Nullable Object obj) {
        return (obj instanceof IInventoryImpl) && Intrinsics.areEqual(((IInventoryImpl) obj).wrapped, this.wrapped);
    }
}
