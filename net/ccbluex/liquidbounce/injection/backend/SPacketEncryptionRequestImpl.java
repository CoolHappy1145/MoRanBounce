...
public final class SPacketEncryptionRequestImpl extends PacketImpl implements ISPacketEncryptionRequest {
    ...
    @Override // net.ccbluex.liquidbounce.api.minecraft.network.login.server.ISPacketEncryptionRequest
    @NotNull
    public byte[] getVerifyToken() {
        byte[] bArrFunc_149607_e = getWrapped().func_149607_e();
        Intrinsics.checkExpressionValueIsNotNull(bArrFunc_149607_e, "wrapped.verifyToken");
        return bArrFunc_149607_e;
    }
}
