...
public final class SPacketAnimationImpl extends PacketImpl implements ISPacketAnimation {
    ...
    @Override // net.ccbluex.liquidbounce.api.minecraft.network.play.server.ISPacketAnimation
    public int getAnimationType() {
        return getWrapped().func_148977_d();
    }

    @Override // net.ccbluex.liquidbounce.api.minecraft.network.play.server.ISPacketAnimation
    public int getEntityID() {
        return getWrapped().func_148978_c();
    }
}
