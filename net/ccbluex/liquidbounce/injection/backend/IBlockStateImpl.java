...
public final class IBlockStateImpl implements IIBlockState {
    ...
    @Override // net.ccbluex.liquidbounce.api.minecraft.block.state.IIBlockState
    @NotNull
    public IBlock getBlock() {
        Block blockFunc_177230_c = this.wrapped.func_177230_c();
        Intrinsics.checkExpressionValueIsNotNull(blockFunc_177230_c, "wrapped.block");
        return new BlockImpl(blockFunc_177230_c);
    }

    public boolean equals(@Nullable Object obj) {
        return (obj instanceof IBlockStateImpl) && Intrinsics.areEqual(((IBlockStateImpl) obj).wrapped, this.wrapped);
    }
}
