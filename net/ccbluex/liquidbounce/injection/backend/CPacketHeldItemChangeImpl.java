...
public final class CPacketHeldItemChangeImpl extends PacketImpl implements ICPacketHeldItemChange {
    ...
    @Override // net.ccbluex.liquidbounce.api.minecraft.network.play.client.ICPacketHeldItemChange
    public int getSlotId() {
        return getWrapped().func_149614_c();
    }
}
