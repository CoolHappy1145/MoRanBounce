...
public final class SPacketCloseWindowImpl extends PacketImpl implements ISPacketCloseWindow {
    ...
    @Override // net.ccbluex.liquidbounce.api.minecraft.network.play.client.ISPacketCloseWindow
    public int getWindowId() {
        return getWrapped().field_148896_a;
    }
}
