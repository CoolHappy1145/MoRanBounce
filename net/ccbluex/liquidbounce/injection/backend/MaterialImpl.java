...
public final class MaterialImpl implements IMaterial {
    ...
    @Override // net.ccbluex.liquidbounce.api.minecraft.block.material.IMaterial
    public boolean isReplaceable() {
        return this.wrapped.func_76222_j();
    }

    public boolean equals(@Nullable Object obj) {
        return (obj instanceof MaterialImpl) && Intrinsics.areEqual(((MaterialImpl) obj).wrapped, this.wrapped);
    }
}
