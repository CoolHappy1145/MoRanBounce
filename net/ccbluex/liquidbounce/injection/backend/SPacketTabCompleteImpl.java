...
public final class SPacketTabCompleteImpl extends PacketImpl implements ISPacketTabComplete {
    ...
    @Override // net.ccbluex.liquidbounce.api.minecraft.network.play.server.ISPacketTabComplete
    @NotNull
    public String[] getCompletions() {
        String[] strArrFunc_149630_c = getWrapped().func_149630_c();
        Intrinsics.checkExpressionValueIsNotNull(strArrFunc_149630_c, "wrapped.matches");
        return strArrFunc_149630_c;
    }
}
