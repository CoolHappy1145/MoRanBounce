...
public final class GuiChestImpl extends GuiContainerImpl implements IGuiChest {
    ...
    @Override // net.ccbluex.liquidbounce.api.minecraft.client.gui.inventory.IGuiChest
    public int getInventoryRows() {
        return getWrapped().field_147018_x;
    }

    @Override // net.ccbluex.liquidbounce.api.minecraft.client.gui.inventory.IGuiChest
    @Nullable
    public IIInventory getLowerChestInventory() {
        IInventory iInventory = getWrapped().field_147015_w;
        if (iInventory != null) {
    ...
    @Override // net.ccbluex.liquidbounce.injection.backend.GuiContainerImpl, net.ccbluex.liquidbounce.api.minecraft.client.gui.inventory.IGuiContainer
    @Nullable
