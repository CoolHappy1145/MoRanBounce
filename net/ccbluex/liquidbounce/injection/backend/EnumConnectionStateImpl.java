...
public final class EnumConnectionStateImpl implements IEnumConnectionState {
    ...
    @Override // net.ccbluex.liquidbounce.api.minecraft.network.IEnumConnectionState
    public boolean isHandshake() {
        return this.wrapped == EnumConnectionState.HANDSHAKING;
    }

    public boolean equals(@Nullable Object obj) {
        return (obj instanceof EnumConnectionStateImpl) && ((EnumConnectionStateImpl) obj).wrapped == this.wrapped;
    }
}
