...
/* loaded from: L-out.jar:org/apache/log4j/net/SyslogAppender.class */
public class SyslogAppender extends AppenderSkeleton {
    ...
    private void splitPacket(String header, String packet) throws IOException {
    ...
    public void activateOptions() throws IOException {
        if (this.header) {
            getLocalHostname();
        }
        if (this.layout != null && this.layout.getHeader() != null) {
    ...
    private void sendLayoutMessage(String msg) throws IOException {
        if (this.sqw != null) {
            String packet = msg;
