...
@Metadata(m24mv = {1, 1, OPCode.EXACTN_IC}, m25bv = {1, 0, 3}, m23k = 5, m30xi = 1, m26d1 = {"\ufffd\ufffd$\n\ufffd\ufffd\n\u0002\u0010\u000b\n\u0002\u0018\u0002\n\u0002\b\u0005\n\u0002\u0010\u000e\n\u0002\b\u0003\n\u0002\u0010\b\n\u0002\b\u0005\n\u0002\u0018\u0002\n\ufffd\ufffd\u001a\u0011\u0010\u000b\u001a\u00020\f*\u00020\bH\u0002\u00a2\u0006\u0002\b\r\u001a\u001c\u0010\u000e\u001a\u00020\u0002*\u00020\u00022\u0006\u0010\u000f\u001a\u00020\f2\u0006\u0010\u0010\u001a\u00020\fH\ufffd\ufffd\u001a\f\u0010\u0011\u001a\u00020\u0012*\u00020\u0002H\ufffd\ufffd\"\u0015\u0010\ufffd\ufffd\u001a\u00020\u0001*\u00020\u00028F\u00a2\u0006\u0006\u001a\u0004\b\ufffd\ufffd\u0010\u0003\"\u0018\u0010\u0004\u001a\u00020\u0002*\u00020\u00028@X\u0080\u0004\u00a2\u0006\u0006\u001a\u0004\b\u0005\u0010\u0006\"\u0018\u0010\u0007\u001a\u00020\b*\u00020\u00028@X\u0080\u0004\u00a2\u0006\u0006\u001a\u0004\b\t\u0010\n\u00a8\u0006\u0013"}, m27d2 = {"isRooted", "", "Ljava/io/File;", "(Ljava/io/File;)Z", "root", "getRoot", "(Ljava/io/File;)Ljava/io/File;", "rootName", "", "getRootName", "(Ljava/io/File;)Ljava/lang/String;", "getRootLength", "", "getRootLength$FilesKt__FilePathComponentsKt", "subPath", "beginIndex", "endIndex", "toComponents", "Lkotlin/io/FilePathComponents;", "kotlin-stdlib"}, m28xs = "kotlin/io/FilesKt")
/* loaded from: L-out.jar:kotlin/io/FilesKt__FilePathComponentsKt.class */
class FilesKt__FilePathComponentsKt {
    private static final int getRootLength$FilesKt__FilePathComponentsKt(@NotNull String str) {
        int iIndexOf$default;
        int iIndexOf$default2 = StringsKt.indexOf$default((CharSequence) str, File.separatorChar, 0, false, 4, (Object) null);
        if (iIndexOf$default2 == 0) {
            if (str.length() > 1 && str.charAt(1) == File.separatorChar && (iIndexOf$default = StringsKt.indexOf$default((CharSequence) str, File.separatorChar, 2, false, 4, (Object) null)) >= 0) {
                int iIndexOf$default3 = StringsKt.indexOf$default((CharSequence) str, File.separatorChar, iIndexOf$default + 1, false, 4, (Object) null);
                if (iIndexOf$default3 >= 0) {
                    return iIndexOf$default3 + 1;
                }
                return str.length();
            }
            return 1;
