...
class StringsKt__StringsKt extends StringsKt__StringsJVMKt {
    ...
    public static final CharSequence trim(@NotNull CharSequence trim, @NotNull Function1 predicate) {
        ...
        boolean z = false;
        while (i <= length) {
            boolean zBooleanValue = ((Boolean) predicate.invoke(Character.valueOf(trim.charAt(!z ? i : length)))).booleanValue();
            if (!z) {
                if (!zBooleanValue) {
                    z = true;
                } else {
    ...
    @NotNull
    public static final String trim(@NotNull String trim, @NotNull Function1 predicate) {
        Intrinsics.checkParameterIsNotNull(trim, "$this$trim");
        Intrinsics.checkParameterIsNotNull(predicate, "predicate");
        String str = trim;
        int i = 0;
        ...
        boolean z = false;
        while (i <= length) {
            boolean zBooleanValue = ((Boolean) predicate.invoke(Character.valueOf(str.charAt(!z ? i : length)))).booleanValue();
            if (!z) {
                if (!zBooleanValue) {
                    z = true;
                } else {
    ...
    @NotNull
    public static final CharSequence trimStart(@NotNull CharSequence trimStart, @NotNull Function1 predicate) {
    ...
    @NotNull
    public static final String trimStart(@NotNull String trimStart, @NotNull Function1 predicate) {
    ...
    @NotNull
    public static final CharSequence trimEnd(@NotNull CharSequence trimEnd, @NotNull Function1 predicate) {
    ...
    @NotNull
    public static final String trimEnd(@NotNull String trimEnd, @NotNull Function1 predicate) {
        String strSubSequence;
        Intrinsics.checkParameterIsNotNull(trimEnd, "$this$trimEnd");
        Intrinsics.checkParameterIsNotNull(predicate, "predicate");
        String str = trimEnd;
    ...
    @NotNull
    public static final CharIterator iterator(@NotNull CharSequence iterator) {
        Intrinsics.checkParameterIsNotNull(iterator, "$this$iterator");
        return new CharIterator(iterator) { // from class: kotlin.text.StringsKt__StringsKt.iterator.1
            private int index;
    ...
    private static final Object ifEmpty(CharSequence charSequence, Function0 function0) {
        return charSequence.length() == 0 ? function0.invoke() : charSequence;
    }

    @SinceKotlin(version = "1.3")
    @InlineOnly
    private static final Object ifBlank(CharSequence charSequence, Function0 function0) {
        return StringsKt.isBlank(charSequence) ? function0.invoke() : charSequence;
    }
    ...
    public static final boolean hasSurrogatePairAt(@NotNull CharSequence hasSurrogatePairAt, int i) {
        ...
        return 0 <= i && hasSurrogatePairAt.length() - 2 >= i && Character.isHighSurrogate(hasSurrogatePairAt.charAt(i)) && Character.isLowSurrogate(hasSurrogatePairAt.charAt(i + 1));
    }
    ...
    public static final String replaceBefore(@NotNull String replaceBefore, char c, @NotNull String replacement, @NotNull String missingDelimiterValue) {
        ...
        Intrinsics.checkParameterIsNotNull(replacement, "replacement");
        Intrinsics.checkParameterIsNotNull(missingDelimiterValue, "missingDelimiterValue");
        int iIndexOf$default = StringsKt.indexOf$default((CharSequence) replaceBefore, c, 0, false, 6, (Object) null);
        return iIndexOf$default == -1 ? missingDelimiterValue : StringsKt.replaceRange((CharSequence) replaceBefore, 0, iIndexOf$default, (CharSequence) replacement).toString();
    }
    ...
    public static final String replaceBefore(@NotNull String replaceBefore, @NotNull String delimiter, @NotNull String replacement, @NotNull String missingDelimiterValue) {
        ...
        Intrinsics.checkParameterIsNotNull(replacement, "replacement");
        Intrinsics.checkParameterIsNotNull(missingDelimiterValue, "missingDelimiterValue");
        int iIndexOf$default = StringsKt.indexOf$default((CharSequence) replaceBefore, delimiter, 0, false, 6, (Object) null);
        return iIndexOf$default == -1 ? missingDelimiterValue : StringsKt.replaceRange((CharSequence) replaceBefore, 0, iIndexOf$default, (CharSequence) replacement).toString();
    }
    ...
    public static final String replaceAfter(@NotNull String replaceAfter, char c, @NotNull String replacement, @NotNull String missingDelimiterValue) {
        ...
        Intrinsics.checkParameterIsNotNull(replacement, "replacement");
        Intrinsics.checkParameterIsNotNull(missingDelimiterValue, "missingDelimiterValue");
        int iIndexOf$default = StringsKt.indexOf$default((CharSequence) replaceAfter, c, 0, false, 6, (Object) null);
        if (iIndexOf$default == -1) {
            return missingDelimiterValue;
        }
        return StringsKt.replaceRange((CharSequence) replaceAfter, iIndexOf$default + 1, replaceAfter.length(), (CharSequence) replacement).toString();
    }
    ...
    public static final String replaceAfter(@NotNull String replaceAfter, @NotNull String delimiter, @NotNull String replacement, @NotNull String missingDelimiterValue) {
        ...
        Intrinsics.checkParameterIsNotNull(replacement, "replacement");
        Intrinsics.checkParameterIsNotNull(missingDelimiterValue, "missingDelimiterValue");
        int iIndexOf$default = StringsKt.indexOf$default((CharSequence) replaceAfter, delimiter, 0, false, 6, (Object) null);
        if (iIndexOf$default == -1) {
            return missingDelimiterValue;
        }
        return StringsKt.replaceRange((CharSequence) replaceAfter, iIndexOf$default + delimiter.length(), replaceAfter.length(), (CharSequence) replacement).toString();
    }
    ...
    public static final String replaceAfterLast(@NotNull String replaceAfterLast, @NotNull String delimiter, @NotNull String replacement, @NotNull String missingDelimiterValue) {
        ...
        Intrinsics.checkParameterIsNotNull(replacement, "replacement");
        Intrinsics.checkParameterIsNotNull(missingDelimiterValue, "missingDelimiterValue");
        int iLastIndexOf$default = StringsKt.lastIndexOf$default((CharSequence) replaceAfterLast, delimiter, 0, false, 6, (Object) null);
        if (iLastIndexOf$default == -1) {
            return missingDelimiterValue;
        }
        return StringsKt.replaceRange((CharSequence) replaceAfterLast, iLastIndexOf$default + delimiter.length(), replaceAfterLast.length(), (CharSequence) replacement).toString();
    }
    ...
    public static final String replaceAfterLast(@NotNull String replaceAfterLast, char c, @NotNull String replacement, @NotNull String missingDelimiterValue) {
        ...
        Intrinsics.checkParameterIsNotNull(replacement, "replacement");
        Intrinsics.checkParameterIsNotNull(missingDelimiterValue, "missingDelimiterValue");
        int iLastIndexOf$default = StringsKt.lastIndexOf$default((CharSequence) replaceAfterLast, c, 0, false, 6, (Object) null);
        if (iLastIndexOf$default == -1) {
            return missingDelimiterValue;
        }
        return StringsKt.replaceRange((CharSequence) replaceAfterLast, iLastIndexOf$default + 1, replaceAfterLast.length(), (CharSequence) replacement).toString();
    }
    ...
    public static final String replaceBeforeLast(@NotNull String replaceBeforeLast, char c, @NotNull String replacement, @NotNull String missingDelimiterValue) {
        ...
        Intrinsics.checkParameterIsNotNull(replacement, "replacement");
        Intrinsics.checkParameterIsNotNull(missingDelimiterValue, "missingDelimiterValue");
        int iLastIndexOf$default = StringsKt.lastIndexOf$default((CharSequence) replaceBeforeLast, c, 0, false, 6, (Object) null);
        return iLastIndexOf$default == -1 ? missingDelimiterValue : StringsKt.replaceRange((CharSequence) replaceBeforeLast, 0, iLastIndexOf$default, (CharSequence) replacement).toString();
    }
    ...
    public static final String replaceBeforeLast(@NotNull String replaceBeforeLast, @NotNull String delimiter, @NotNull String replacement, @NotNull String missingDelimiterValue) {
        ...
        Intrinsics.checkParameterIsNotNull(replacement, "replacement");
        Intrinsics.checkParameterIsNotNull(missingDelimiterValue, "missingDelimiterValue");
        int iLastIndexOf$default = StringsKt.lastIndexOf$default((CharSequence) replaceBeforeLast, delimiter, 0, false, 6, (Object) null);
        return iLastIndexOf$default == -1 ? missingDelimiterValue : StringsKt.replaceRange((CharSequence) replaceBeforeLast, 0, iLastIndexOf$default, (CharSequence) replacement).toString();
    }
    ...
    @InlineOnly
    private static final String replace(@NotNull CharSequence charSequence, Regex regex, Function1 function1) {
    ...
    private static final int indexOf$StringsKt__StringsKt(@NotNull CharSequence charSequence, CharSequence charSequence2, int i, int i2, boolean z, boolean z2) {
        ...
        IntProgression intProgression = intRangeDownTo;
    ...
    private static final Pair findAnyOf$StringsKt__StringsKt(@NotNull CharSequence charSequence, Collection collection, int i, boolean z, boolean z2) {
        Object obj;
        Object obj2;
        if (!z && collection.size() == 1) {
            ...
            return TuplesKt.m32to(Integer.valueOf(iIndexOf$default), str);
        }
        ...
        if (charSequence instanceof String) {
            ...
            while (true) {
                ...
                if (str3 == null) {
                    ...
                    return TuplesKt.m32to(Integer.valueOf(first), str3);
                }
            }
        } else {
            ...
            while (true) {
                ...
                if (str5 == null) {
                    ...
                    return TuplesKt.m32to(Integer.valueOf(first2), str5);
                }
            }
        }
    }
    ...
    @Nullable
    public static final Pair findAnyOf(@NotNull CharSequence findAnyOf, @NotNull Collection strings, int i, boolean z) {
    ...
    @Nullable
    public static final Pair findLastAnyOf(@NotNull CharSequence findLastAnyOf, @NotNull Collection strings, int i, boolean z) {
    ...
    public static final int indexOfAny(@NotNull CharSequence indexOfAny, @NotNull Collection strings, int i, boolean z) {
        Intrinsics.checkParameterIsNotNull(indexOfAny, "$this$indexOfAny");
        Intrinsics.checkParameterIsNotNull(strings, "strings");
        Pair pairFindAnyOf$StringsKt__StringsKt = findAnyOf$StringsKt__StringsKt(indexOfAny, strings, i, z, false);
        if (pairFindAnyOf$StringsKt__StringsKt != null) {
            Integer num = (Integer) pairFindAnyOf$StringsKt__StringsKt.getFirst();
            if (num != null) {
                return num.intValue();
            }
        }
    ...
    public static final int lastIndexOfAny(@NotNull CharSequence lastIndexOfAny, @NotNull Collection strings, int i, boolean z) {
        Intrinsics.checkParameterIsNotNull(lastIndexOfAny, "$this$lastIndexOfAny");
        Intrinsics.checkParameterIsNotNull(strings, "strings");
        Pair pairFindAnyOf$StringsKt__StringsKt = findAnyOf$StringsKt__StringsKt(lastIndexOfAny, strings, i, z, true);
        if (pairFindAnyOf$StringsKt__StringsKt != null) {
            Integer num = (Integer) pairFindAnyOf$StringsKt__StringsKt.getFirst();
            if (num != null) {
                return num.intValue();
    ...
    private static final Sequence rangesDelimitedBy$StringsKt__StringsKt(@NotNull CharSequence charSequence, final char[] cArr, int i, final boolean z, int i2) {
        if (!(i2 >= 0)) {
            throw new IllegalArgumentException(("Limit must be non-negative, but was " + i2 + '.').toString());
        }
        return new DelimitedRangesSequence(charSequence, i, i2, new Function2(cArr, z) { // from class: kotlin.text.StringsKt__StringsKt$rangesDelimitedBy$2
            ...
            @Nullable
            public final Pair invoke(@NotNull CharSequence receiver, int i3) {
                Intrinsics.checkParameterIsNotNull(receiver, "$receiver");
                int iIndexOfAny = StringsKt.indexOfAny(receiver, this.$delimiters, i3, this.$ignoreCase);
                if (iIndexOfAny < 0) {
                    return null;
                }
                return TuplesKt.m32to(Integer.valueOf(iIndexOfAny), 1);
            }
        });
    }
    ...
    private static final Sequence rangesDelimitedBy$StringsKt__StringsKt(@NotNull CharSequence charSequence, String[] strArr, int i, final boolean z, int i2) {
        if (!(i2 >= 0)) {
            throw new IllegalArgumentException(("Limit must be non-negative, but was " + i2 + '.').toString());
        }
        final List listAsList = ArraysKt.asList(strArr);
        return new DelimitedRangesSequence(charSequence, i, i2, new Function2(listAsList, z) { // from class: kotlin.text.StringsKt__StringsKt$rangesDelimitedBy$4
            ...
            {
                super(2);
                this.$delimitersList = listAsList;
                this.$ignoreCase = z;
            }
            ...
            public final Pair invoke(@NotNull CharSequence receiver, int i3) {
                Intrinsics.checkParameterIsNotNull(receiver, "$receiver");
                Pair pairFindAnyOf$StringsKt__StringsKt = StringsKt__StringsKt.findAnyOf$StringsKt__StringsKt(receiver, this.$delimitersList, i3, this.$ignoreCase, false);
                if (pairFindAnyOf$StringsKt__StringsKt != null) {
                    return TuplesKt.m32to(pairFindAnyOf$StringsKt__StringsKt.getFirst(), Integer.valueOf(((String) pairFindAnyOf$StringsKt__StringsKt.getSecond()).length()));
                }
                return null;
            }
        });
    ...
    @NotNull
    public static final Sequence splitToSequence(@NotNull CharSequence splitToSequence, @NotNull String[] delimiters, boolean z, int i) {
        Intrinsics.checkParameterIsNotNull(splitToSequence, "$this$splitToSequence");
        Intrinsics.checkParameterIsNotNull(delimiters, "delimiters");
        return SequencesKt.map(rangesDelimitedBy$StringsKt__StringsKt$default(splitToSequence, delimiters, 0, z, i, 2, (Object) null), new Function1(splitToSequence) { // from class: kotlin.text.StringsKt__StringsKt.splitToSequence.1
            ...
            {
                super(1);
                this.$this_splitToSequence = splitToSequence;
            }
    ...
    @NotNull
    public static final List split(@NotNull CharSequence split, @NotNull String[] delimiters, boolean z, int i) {
    ...
    @NotNull
    public static final Sequence splitToSequence(@NotNull CharSequence splitToSequence, @NotNull char[] delimiters, boolean z, int i) {
        Intrinsics.checkParameterIsNotNull(splitToSequence, "$this$splitToSequence");
        Intrinsics.checkParameterIsNotNull(delimiters, "delimiters");
        return SequencesKt.map(rangesDelimitedBy$StringsKt__StringsKt$default(splitToSequence, delimiters, 0, z, i, 2, (Object) null), new Function1(splitToSequence) { // from class: kotlin.text.StringsKt__StringsKt.splitToSequence.2
            final CharSequence $this_splitToSequence;
    ...
    @NotNull
    public static final List split(@NotNull CharSequence split, @NotNull char[] delimiters, boolean z, int i) {
        Intrinsics.checkParameterIsNotNull(split, "$this$split");
        Intrinsics.checkParameterIsNotNull(delimiters, "delimiters");
        if (delimiters.length == 1) {
    ...
    private static final List split$StringsKt__StringsKt(@NotNull CharSequence charSequence, String str, boolean z, int i) {
        if (!(i >= 0)) {
    ...
    @InlineOnly
    private static final List split(@NotNull CharSequence charSequence, Regex regex, int i) {
    ...
    @NotNull
    public static final Sequence lineSequence(@NotNull CharSequence lineSequence) {
        Intrinsics.checkParameterIsNotNull(lineSequence, "$this$lineSequence");
        return StringsKt.splitToSequence$default(lineSequence, new String[]{HTTP.CRLF, "\n", "\r"}, false, 0, 6, (Object) null);
    }

    @NotNull
    public static final List lines(@NotNull CharSequence lines) {
