...
/* loaded from: L-out.jar:jdk/nashorn/internal/codegen/LocalVariableTypesCalculator.class */
final class LocalVariableTypesCalculator extends SimpleNodeVisitor {
    ...
    /* loaded from: L-out.jar:jdk/nashorn/internal/codegen/LocalVariableTypesCalculator$JumpOrigin.class */
    private static class JumpOrigin {
        final JoinPredecessor node;
        final Map types;

        JumpOrigin(JoinPredecessor joinPredecessor, Map map) {
            this.node = joinPredecessor;
            this.types = map;
        }
    }

    /* loaded from: L-out.jar:jdk/nashorn/internal/codegen/LocalVariableTypesCalculator$JumpTarget.class */
    private static class JumpTarget {
        ...
        JumpTarget(C01251 c01251) {
            this();
        }

        void addOrigin(JoinPredecessor joinPredecessor, Map map, LocalVariableTypesCalculator localVariableTypesCalculator) {
            this.origins.add(new JumpOrigin(joinPredecessor, map));
            this.types = localVariableTypesCalculator.getUnionTypes(this.types, map);
        }
    }

    /* loaded from: L-out.jar:jdk/nashorn/internal/codegen/LocalVariableTypesCalculator$LvarType.class */
    ...
    /* loaded from: L-out.jar:jdk/nashorn/internal/codegen/LocalVariableTypesCalculator$TypeHolderExpression.class */
    ...
    /* loaded from: L-out.jar:jdk/nashorn/internal/codegen/LocalVariableTypesCalculator$SymbolConversions.class */
    private static class SymbolConversions {
        ...
        SymbolConversions(C01251 c01251) {
            this();
        }

        void recordConversion(LvarType lvarType, LvarType lvarType2) {
            switch (C01262.f16xf47a80b1[lvarType.ordinal()]) {
                case 1:
                ...
                case 4:
                case 5:
                    switch (C01262.f16xf47a80b1[lvarType2.ordinal()]) {
                        case 1:
        ...
        private static void illegalConversion(LvarType lvarType, LvarType lvarType2) {
            throw new AssertionError("Invalid conversion from " + lvarType + " to " + lvarType2);
        }
    ...
    private void symbolIsConverted(Symbol symbol, LvarType from, LvarType to) {
        ...
        if (conversions == null) {
            conversions = new SymbolConversions(null);
    ...
    private JumpTarget createJumpTarget(Label label) {
        ...
        JumpTarget jumpTarget = new JumpTarget(null);
    ...
    private boolean enterJumpStatement(JumpStatement jump) {
        ...
        assertTypeStackIsEmpty();
        jumpToLabel(jump, jump.getTargetLabel(this.f30lc), getBreakTargetTypes(jump.getPopScopeLimit(this.f30lc)));
    ...
    private Map<Symbol, LvarType> getBreakTargetTypes(LexicalContextNode target) {
        ...
        Iterator<LexicalContextNode> it = this.f30lc.getAllNodes();
        while (it.hasNext()) {
    ...
    public Node leaveBlock(Block block) {
        ...
        if (this.reachable && (labelNode = this.f30lc.getCurrentBlockLabelNode()) != null) {
    ...
    private void createSyntheticReturn(Block body) {
        ...
        FunctionNode functionNode = this.f30lc.getCurrentFunction();
        ...
        SimpleNodeVisitor applyChangesVisitor = new SimpleNodeVisitor() { // from class: jdk.nashorn.internal.codegen.LocalVariableTypesCalculator.1
            ...
            public Node leaveBinaryNode(BinaryNode binaryNode) {
                if (binaryNode.isComparison()) {
                    ...
                    switch (C01262.$SwitchMap$jdk$nashorn$internal$parser$TokenType[tt.ordinal()]) {
                        case 1:
                        case 2:
            ...
            protected Node leaveDefault(Node node) {
                if (node instanceof JoinPredecessor) {
                    ...
                    if (localVariableConversion instanceof LexicalContextNode) {
                        this.f30lc.replace((LexicalContextNode) node, (LexicalContextNode) localVariableConversion);
                    }
            ...
            @Override // jdk.nashorn.internal.p001ir.visitor.NodeVisitor
            public Node leaveBlock(Block block) {
                if (this.inOuterFunction && LocalVariableTypesCalculator.this.syntheticReturn != null && this.f30lc.isFunctionBody()) {
                    ...
                    return block.setStatements(this.f30lc, stmts);
                }
            ...
            public Node leaveFunctionNode(FunctionNode nestedFunctionNode) {
                ...
                this.f30lc.replace(nestedFunctionNode, newNestedFunction);
            ...
            public Node leaveLiteralNode(LiteralNode<?> literalNode) {
                return literalNode.initialize(this.f30lc);
            }
            ...
            private <T extends JoinPredecessor> T setLocalVariableConversion(JoinPredecessor joinPredecessor, T t) {
                return (T) t.setLocalVariableConversion(this.f30lc, (LocalVariableConversion) LocalVariableTypesCalculator.this.localVariableConversions.get(joinPredecessor));
            }
        };
        FunctionNode newFunction = functionNode.setBody(this.f30lc, (Block) functionNode.getBody().accept(applyChangesVisitor)).setReturnType(this.f30lc, this.returnType);
        return newFunction.setParameters(this.f30lc, newFunction.visitParameters(applyChangesVisitor));
    }

    /* renamed from: jdk.nashorn.internal.codegen.LocalVariableTypesCalculator$2 */
    /* loaded from: L-out.jar:jdk/nashorn/internal/codegen/LocalVariableTypesCalculator$2.class */
    static /* synthetic */ class C01262 {

        /* renamed from: $SwitchMap$jdk$nashorn$internal$codegen$LocalVariableTypesCalculator$LvarType */
        static final int[] f16xf47a80b1;
        ...
        static {
            ...
            f16xf47a80b1 = new int[LvarType.values().length];
            try {
                f16xf47a80b1[LvarType.DOUBLE.ordinal()] = 1;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f16xf47a80b1[LvarType.OBJECT.ordinal()] = 2;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f16xf47a80b1[LvarType.UNDEFINED.ordinal()] = 3;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f16xf47a80b1[LvarType.INT.ordinal()] = 4;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f16xf47a80b1[LvarType.BOOLEAN.ordinal()] = 5;
