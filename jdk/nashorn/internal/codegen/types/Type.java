...
/* loaded from: L-out.jar:jdk/nashorn/internal/codegen/types/Type.class */
public abstract class Type implements Comparable<Type>, BytecodeOps, Serializable {
    ...
    /* loaded from: L-out.jar:jdk/nashorn/internal/codegen/types/Type$Unknown.class */
    ...
    static {
        ...
        BOOTSTRAP = CompilerConstants.staticCallNoLookup(Bootstrap.class, "mathBootstrap", CallSite.class, new Class[]{MethodHandles.Lookup.class, String.class, MethodType.class, Integer.TYPE});
    ...
    static void invokestatic(MethodVisitor method, CompilerConstants.Call call) {
        method.visitMethodInsn(SyslogAppender.LOG_LOCAL7, call.className(), call.name(), call.descriptor(), false);
    }
    ...
    /* loaded from: L-out.jar:jdk/nashorn/internal/codegen/types/Type$ValueLessType.class */
    private static abstract class ValueLessType extends Type {
        ...
        public Type convert(MethodVisitor methodVisitor, Type type) {
            throw new UnsupportedOperationException("convert => " + type);
        }
