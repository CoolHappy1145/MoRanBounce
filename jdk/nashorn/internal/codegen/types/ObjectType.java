...
/* loaded from: L-out.jar:jdk/nashorn/internal/codegen/types/ObjectType.class */
class ObjectType extends Type {
    ...
    public Type convert(MethodVisitor method, Type to) {
        ...
        if (to.isInteger()) {
            ...
            throw new UnsupportedOperationException("Illegal conversion " + this + ActivityStack.GLUE_STRING + to + " " + isString() + " " + toString);
        }
        return to;
    }
