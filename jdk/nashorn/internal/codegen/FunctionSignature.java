...
/* loaded from: L-out.jar:jdk/nashorn/internal/codegen/FunctionSignature.class */
public final class FunctionSignature {
    ...
    private FunctionSignature(boolean hasSelf, boolean hasCallee, Type retType, Type... argTypes) {
        ...
        this.methodType = Lookup.f31MH.type(this.returnType.getTypeClass(), (Class[]) paramTypeList.toArray(new Class[this.paramTypes.length]));
    }
