...
/* loaded from: L-out.jar:jdk/nashorn/internal/codegen/WeighNodes.class */
final class WeighNodes extends NodeOperatorVisitor {
    ...
    private WeighNodes(FunctionNode functionNode, Map map) {
    ...
    static long weigh(Node node, Map map) {
    ...
    public boolean enterLiteralNode(LiteralNode literalNode) {
        ...
        if (literalNode instanceof LiteralNode.ArrayLiteralNode) {
            ...
            Node[] nodeArr = (Node[]) arrayLiteralNode.getValue();
