...
/* loaded from: L-out.jar:jdk/nashorn/internal/codegen/MethodEmitter.class */
public class MethodEmitter {
    ...
    MethodEmitter(ClassEmitter classEmitter, MethodVisitor method, FunctionNode functionNode) {
        ...
        this.PRINT = CompilerConstants.virtualCallNoLookup(PrintStream.class, "print", Void.TYPE, new Class[]{Object.class});
        this.PRINTLN = CompilerConstants.virtualCallNoLookup(PrintStream.class, "println", Void.TYPE, new Class[]{Object.class});
    ...
    public String toString() {
        return "methodEmitter: " + (this.functionNode == null ? this.method : this.functionNode.getName()).toString() + ' ' + Debug.m11id(this);
    }
    ...
    MethodEmitter _new(String classDescriptor, Type type) {
        ...
        this.method.visitTypeInsn(Typography.rightGuillemete, classDescriptor);
        pushType(type);
        return this;
    }
    ...
    MethodEmitter m5or() {
        debug("or");
        pushType(get2i().mo6or(this.method));
        return this;
    }
    ...
    MethodEmitter load(String s) {
        ...
        if (length > 32768) {
            ...
            dup();
            load(length);
            invoke(CompilerConstants.constructorNoLookup(StringBuilder.class, new Class[]{Integer.TYPE}));
            int i = 0;
            while (true) {
                int n = i;
                if (n < length) {
    ...
    /* loaded from: L-out.jar:jdk/nashorn/internal/codegen/MethodEmitter$LocalVariableDef.class */
    ...
    MethodEmitter invokespecial(String className, String methodName, String methodDescriptor) {
        ...
        return invoke(Typography.middleDot, className, methodName, methodDescriptor, true);
    }
    ...
    MethodEmitter invokevirtual(String className, String methodName, String methodDescriptor) {
        ...
        return invoke(Typography.paragraph, className, methodName, methodDescriptor, true);
    }
    ...
    MethodEmitter invokestatic(String className, String methodName, String methodDescriptor) {
        ...
        invoke(SyslogAppender.LOG_LOCAL7, className, methodName, methodDescriptor, false);
        return this;
    }
    ...
    void returnVoid() {
        ...
        this.method.visitInsn(Typography.plusMinus);
        doesNotContinueSequentially();
    }
    ...
    void if_icmpge(Label label) {
        ...
        jump(Typography.cent, label, 2);
    }

    void _goto(Label label) {
        debug("goto", label);
        jump(Typography.section, label, 0);
        doesNotContinueSequentially();
    }

    void gotoLoopStart(Label loopStart) {
        debug("goto (loop)", loopStart);
        jump(Typography.section, loopStart, 0);
    }

    void uncheckedGoto(Label target) {
        this.method.visitJumpInsn(Typography.section, target.getLabel());
    }
    ...
    void breakLabel(Label label, int liveLocals) {
        ...
        this.stack = labelStack == null ? null : labelStack.m179clone();
    ...
    void dynamicSet(String name, int flags, boolean isIndex) {
        ...
        popType(type);
        popType(Type.SCOPE);
        this.method.visitInvokeDynamicInsn(dynSetOperation(isIndex) + ':' + NameCodec.encode(name), CompilerConstants.methodDescriptor(Void.TYPE, new Class[]{Object.class, type.getTypeClass()}), LINKERBOOTSTRAP, new Object[]{Integer.valueOf(flags)});
    }
    ...
    void dynamicSetIndex(int flags) {
        ...
        this.method.visitInvokeDynamicInsn("dyn:setElem|setProp", CompilerConstants.methodDescriptor(Void.TYPE, new Class[]{receiver.getTypeClass(), index.getTypeClass(), value.getTypeClass()}), LINKERBOOTSTRAP, new Object[]{Integer.valueOf(flags)});
    }
        ...
        if (this.debug) {
            ...
            if (isReachable() && !this.stack.isEmpty()) {
                ...
                for (int pos = 0; pos < this.stack.size(); pos++) {
                    ...
                    int loadIndex = this.stack.localLoads[(this.stack.f15sp - 1) - pos];
                    if (loadIndex != -1) {
