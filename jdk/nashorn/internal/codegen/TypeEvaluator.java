...
/* loaded from: L-out.jar:jdk/nashorn/internal/codegen/TypeEvaluator.class */
final class TypeEvaluator {
    ...
    private static Type getPropertyType(ScriptObject sobj, String name) {
        ...
        return Type.typeFor((Class<?>) JSType.unboxedFieldType(value));
    }
        ...
        if (expr instanceof CallNode) {
            ...
            if ((fnExpr instanceof FunctionNode) && this.compiler.getContext().getEnv()._lazy_compilation) {
                ...
                if (callExpr.getArgs().isEmpty() && (data = this.compiler.getScriptFunctionData(fn.getId())) != null) {
                    Type returnType = Type.typeFor((Class<?>) data.getReturnType(EMPTY_INVOCATION_TYPE, this.runtimeScope));
