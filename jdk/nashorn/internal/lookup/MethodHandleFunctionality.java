...
/* loaded from: L-out.jar:jdk/nashorn/internal/lookup/MethodHandleFunctionality.class */
public interface MethodHandleFunctionality {
    ...
    MethodHandle dropArguments(MethodHandle methodHandle, int i, List list);
    ...
    MethodHandle throwException(Class cls, Class cls2);

    MethodHandle catchException(MethodHandle methodHandle, Class cls, MethodHandle methodHandle2);
