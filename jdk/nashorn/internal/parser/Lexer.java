...
/* loaded from: L-out.jar:jdk/nashorn/internal/parser/Lexer.class */
public class Lexer extends Scanner {
    ...
    /* loaded from: L-out.jar:jdk/nashorn/internal/parser/Lexer$LineInfoReceiver.class */
    ...
    /* synthetic */ Lexer(Lexer x0, State x1, C02011 x2) {
        this(x0, x1);
    }
    ...
    /* loaded from: L-out.jar:jdk/nashorn/internal/parser/Lexer$State.class */
    static class State extends Scanner.State {
        ...
        State(int i, int i2, int i3, int i4, int i5, TokenType tokenType) {
            super(i, i2, i3);
            this.pendingLine = i4;
    ...
    /* loaded from: L-out.jar:jdk/nashorn/internal/parser/Lexer$EditStringLexer.class */
        ...
        public void lexify() {
            ...
            while (!atEOF()) {
                if (this.ch0 == '\\' && this.stringType == TokenType.ESCSTRING) {
                    ...
                    skip(2);
                    State stateSaveState = saveState();
                    int i2 = 1;
                    while (!atEOF()) {
                        if (this.ch0 == '}') {
                            i2--;
                    ...
                    if (i2 != 0) {
                        error(Lexer.message("edit.string.missing.brace", new String[0]), TokenType.LBRACE, stateSaveState.position - 1, 1);
                    }
                    stateSaveState.setLimit(this.position);
                    skip(1);
                    i = this.position;
                    add(TokenType.ADD, stateSaveState.position, stateSaveState.position + 1);
                    add(TokenType.LPAREN, stateSaveState.position, stateSaveState.position + 1);
                    new Lexer(this, stateSaveState, (C02011) null).lexify();
    ...
    Object getValueOf(long token, boolean strict) {
        ...
        switch (C02011.$SwitchMap$jdk$nashorn$internal$parser$TokenType[Token.descType(token).ordinal()]) {
            case 1:
    ...
    /* renamed from: jdk.nashorn.internal.parser.Lexer$1 */
    /* loaded from: L-out.jar:jdk/nashorn/internal/parser/Lexer$1.class */
    static /* synthetic */ class C02011 {
        ...
        static {
            try {
                $SwitchMap$jdk$nashorn$internal$parser$TokenType[TokenType.DECIMAL.ordinal()] = 1;
            } catch (NoSuchFieldError unused) {
            }
            try {
                $SwitchMap$jdk$nashorn$internal$parser$TokenType[TokenType.OCTAL.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                $SwitchMap$jdk$nashorn$internal$parser$TokenType[TokenType.HEXADECIMAL.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                $SwitchMap$jdk$nashorn$internal$parser$TokenType[TokenType.FLOATING.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                $SwitchMap$jdk$nashorn$internal$parser$TokenType[TokenType.STRING.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                $SwitchMap$jdk$nashorn$internal$parser$TokenType[TokenType.ESCSTRING.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                $SwitchMap$jdk$nashorn$internal$parser$TokenType[TokenType.IDENT.ordinal()] = 7;
            } catch (NoSuchFieldError unused7) {
            }
            try {
                $SwitchMap$jdk$nashorn$internal$parser$TokenType[TokenType.REGEX.ordinal()] = 8;
            } catch (NoSuchFieldError unused8) {
            }
            try {
                $SwitchMap$jdk$nashorn$internal$parser$TokenType[TokenType.XML.ordinal()] = 9;
            } catch (NoSuchFieldError unused9) {
            }
            try {
                $SwitchMap$jdk$nashorn$internal$parser$TokenType[TokenType.DIRECTIVE_COMMENT.ordinal()] = 10;
    ...
    /* loaded from: L-out.jar:jdk/nashorn/internal/parser/Lexer$LexerToken.class */
    public static abstract class LexerToken implements Serializable {
        private static final long serialVersionUID = 1;
        private final String expression;

        protected LexerToken(String str) {
            this.expression = str;
        }
    ...
    /* loaded from: L-out.jar:jdk/nashorn/internal/parser/Lexer$RegexToken.class */
    public static class RegexToken extends LexerToken {
        private static final long serialVersionUID = 1;
        private final String options;

        public RegexToken(String str, String str2) {
            super(str);
            this.options = str2;
        }
    ...
    /* loaded from: L-out.jar:jdk/nashorn/internal/parser/Lexer$XMLToken.class */
