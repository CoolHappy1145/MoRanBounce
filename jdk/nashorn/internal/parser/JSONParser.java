...
/* loaded from: L-out.jar:jdk/nashorn/internal/parser/JSONParser.class */
public class JSONParser {
    ...
    private Object parseObject() {
        PropertyMap propertyMap = this.dualFields ? C0276JD.getInitialMap() : C0277JO.getInitialMap();
    ...
    private Object createObject(PropertyMap propertyMap, List<Object> values, ArrayData arrayData) {
        ...
        ScriptObject object = this.dualFields ? new C0276JD(propertyMap, primitiveSpill, objectSpill) : new C0277JO(propertyMap, null, objectSpill);
