...
/* loaded from: L-out.jar:jdk/nashorn/internal/runtime/regexp/joni/Syntax.class */
public final class Syntax implements SyntaxProperties {

    /* renamed from: op */
    private final int f77op;
    ...
    public Syntax(int i, int i2, int i3, int i4, MetaCharTable metaCharTable) {
        this.f77op = i;
        this.op2 = i2;
        this.behavior = i3;
        this.options = i4;
    ...
    /* loaded from: L-out.jar:jdk/nashorn/internal/runtime/regexp/joni/Syntax$MetaCharTable.class */
    public static class MetaCharTable {
        ...
        public MetaCharTable(int i, int i2, int i3, int i4, int i5, int i6) {
            this.esc = i;
            this.anyChar = i2;
            this.anyTime = i3;
            this.zeroOrOneTime = i4;
            this.oneOrMoreTime = i5;
            this.anyCharAnyTime = i6;
        }
    }

    protected boolean isOp(int i) {
        return (this.f77op & i) != 0;
    }
    ...
    protected boolean isBehavior(int i) {
