...
/* loaded from: L-out.jar:jdk/nashorn/internal/runtime/regexp/joni/ast/Node.class */
    ...
    public void verifyTree(Set<Node> set, WarnCallback warnings) {
        if (!set.contains(this) && getChild() != null) {
            ...
            if (getChild().parent != this) {
                warnings.warn("broken link to child: " + getAddressName() + ActivityStack.GLUE_STRING + getChild().getAddressName());
            }
