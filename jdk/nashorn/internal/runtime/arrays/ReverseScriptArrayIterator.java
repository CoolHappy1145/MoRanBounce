...
/*  JADX ERROR: NullPointerException in pass: ProcessKotlinInternals
    ...
    */
/* loaded from: L-out.jar:jdk/nashorn/internal/runtime/arrays/ReverseScriptArrayIterator.class */
final class ReverseScriptArrayIterator extends ScriptArrayIterator {
    ...
    public ReverseScriptArrayIterator(ScriptObject scriptObject, boolean z) {
        super(scriptObject, z);
        this.index = scriptObject.getArray().length() - 1;
    }
