...
/* loaded from: L-out.jar:jdk/nashorn/internal/runtime/linker/NashornGuards.class */
public final class NashornGuards {
    ...
    public static MethodHandle getMapGuard(PropertyMap map, boolean explicitInstanceOfCheck) {
        return Lookup.f31MH.insertArguments(explicitInstanceOfCheck ? IS_MAP_SCRIPTOBJECT : IS_MAP, 1, new Object[]{map});
    }
    ...
    public static MethodHandle getIdentityGuard(ScriptObject sobj) {
        return Lookup.f31MH.insertArguments(SAME_OBJECT, 1, new Object[]{new WeakReference(sobj)});
    }
    ...
    public static MethodHandle combineGuards(MethodHandle guard1, MethodHandle guard2) {
        ...
        return guard2 == null ? guard1 : Lookup.f31MH.guardWithTest(guard1, guard2, Lookup.f31MH.dropArguments(Lookup.f31MH.constant(Boolean.TYPE, false), 0, new Class[]{Object.class}));
    }
    ...
    private static MethodHandle findOwnMH(String name, Class<?> rtype, Class<?>... types) {
        return Lookup.f31MH.findStatic(MethodHandles.lookup(), NashornGuards.class, name, Lookup.f31MH.type(rtype, types));
    }
}
