...
/* loaded from: L-out.jar:jdk/nashorn/internal/runtime/Context.class */
public final class Context {
    ...
    /* loaded from: L-out.jar:jdk/nashorn/internal/runtime/Context$BuiltinSwitchPoint.class */
    public static final class BuiltinSwitchPoint extends SwitchPoint {
    }

    /* loaded from: L-out.jar:jdk/nashorn/internal/runtime/Context$FieldMode.class */
    ...
    /* loaded from: L-out.jar:jdk/nashorn/internal/runtime/Context$MultiGlobalCompiledScript.class */
    ...
    static {
        ...
        theStructLoader = (StructureLoader) AccessController.doPrivileged(new PrivilegedAction() { // from class: jdk.nashorn.internal.runtime.Context.1
    ...
    /* loaded from: L-out.jar:jdk/nashorn/internal/runtime/Context$ContextCodeInstaller.class */
    public static class ContextCodeInstaller implements CodeInstaller {
        ...
        ContextCodeInstaller(Context context, ScriptLoader scriptLoader, CodeSource codeSource, C02161 c02161) {
            this(context, scriptLoader, codeSource);
        }
        ...
        @Override // jdk.nashorn.internal.runtime.CodeInstaller
        public void initialize(Collection collection, Source source, Object[] objArr) throws PrivilegedActionException {
            try {
                AccessController.doPrivileged(new PrivilegedExceptionAction(this, collection, source, objArr) { // from class: jdk.nashorn.internal.runtime.Context.ContextCodeInstaller.1
                    final Collection val$classes;
                    final Source val$source;
                    final Object[] val$constants;
                    final ContextCodeInstaller this$0;

                    {
                        this.this$0 = this;
                        this.val$classes = collection;
                        this.val$source = source;
                        this.val$constants = objArr;
                    }
                    ...
                    @Override // java.security.PrivilegedExceptionAction
                    public Void run() throws IllegalAccessException, NoSuchFieldException, IllegalArgumentException {
                        for (Class cls : this.val$classes) {
                            Field declaredField = cls.getDeclaredField(CompilerConstants.SOURCE.symbolName());
                            declaredField.setAccessible(true);
                            declaredField.set(null, this.val$source);
                            Field declaredField2 = cls.getDeclaredField(CompilerConstants.CONSTANTS.symbolName());
                            declaredField2.setAccessible(true);
                            declaredField2.set(null, this.val$constants);
                        }
                        return null;
                    }
                });
        ...
        @Override // jdk.nashorn.internal.runtime.CodeInstaller
        public void storeScript(String str, Source source, String str2, Map map, Map map2, Object[] objArr, int i) {
    ...
    /* loaded from: L-out.jar:jdk/nashorn/internal/runtime/Context$ThrowErrorManager.class */
    ...
    public MultiGlobalCompiledScript compileScript(Source source) {
        ...
        return new MultiGlobalCompiledScript(this, createProgramFunctionHandle) { // from class: jdk.nashorn.internal.runtime.Context.2
            final MethodHandle val$createProgramFunctionHandle;
            final Context this$0;

            {
                this.this$0 = this;
                this.val$createProgramFunctionHandle = createProgramFunctionHandle;
            }

            @Override // jdk.nashorn.internal.runtime.Context.MultiGlobalCompiledScript
            public ScriptFunction getFunction(Global global) {
                return Context.invokeCreateProgramFunctionHandle(this.val$createProgramFunctionHandle, global);
            }
        };
    }
    ...
    public Object eval(ScriptObject initialScope, String string, Object callThis, Object location, boolean strict, boolean evalCall) throws IllegalAccessException, IllegalArgumentException {
        Object evalThis;
    ...
    private static Source loadInternal(String srcStr, String prefix, String resourcePath) {
        if (srcStr.startsWith(prefix)) {
            ...
            return (Source) AccessController.doPrivileged(new PrivilegedAction(resource, srcStr) { // from class: jdk.nashorn.internal.runtime.Context.3
                final String val$resource;
                final String val$srcStr;

                {
                    this.val$resource = resource;
                    this.val$srcStr = srcStr;
                }
                ...
                public Source run() {
                    try {
                        URL resource2 = Context.class.getResource(this.val$resource);
                        if (resource2 != null) {
                            return Source.sourceFor(this.val$srcStr, resource2);
                        }
                        return null;
    ...
    public Object loadWithNewGlobal(Object from, Object... args) throws IOException {
        ...
        Global newGlobal = (Global) AccessController.doPrivileged(new PrivilegedAction(this) { // from class: jdk.nashorn.internal.runtime.Context.4
            final Context this$0;
    ...
    private static void checkPackageAccess(SecurityManager sm, String fullName) {
        ...
        if (index != -1) {
            ...
            AccessController.doPrivileged(new PrivilegedAction(sm, pkgName) { // from class: jdk.nashorn.internal.runtime.Context.5
                final SecurityManager val$sm;
                final String val$pkgName;

                {
                    this.val$sm = sm;
                    this.val$pkgName = pkgName;
                }
                ...
                @Override // java.security.PrivilegedAction
                public Void run() {
                    this.val$sm.checkPackageAccess(this.val$pkgName);
                    return null;
                }
    ...
    private synchronized Class<?> compile(Source source, ErrorManager errMan, boolean strict) {
        ...
        CodeInstaller installer = new ContextCodeInstaller(this, loader, cs, null);
        if (storedScript == null) {
    ...
    private ScriptLoader createNewLoader() {
        return (ScriptLoader) AccessController.doPrivileged(new PrivilegedAction(this) { // from class: jdk.nashorn.internal.runtime.Context.6
            final Context this$0;
            ...
            public ScriptLoader run() {
                return new ScriptLoader(this.this$0);
            }
        }, CREATE_LOADER_ACC_CTXT);
    }
    ...
    /* loaded from: L-out.jar:jdk/nashorn/internal/runtime/Context$ClassCache.class */
    ...
    /* loaded from: L-out.jar:jdk/nashorn/internal/runtime/Context$ClassReference.class */
    private static class ClassReference extends SoftReference {
        private final Source source;

        ClassReference(Class cls, ReferenceQueue referenceQueue, Source source) {
