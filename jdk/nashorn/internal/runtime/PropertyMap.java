...
/* loaded from: L-out.jar:jdk/nashorn/internal/runtime/PropertyMap.class */
public class PropertyMap implements Iterable<Object>, Serializable {
    ...
    public static PropertyMap newMap(Collection<Property> properties) {
        return (properties == null || properties.isEmpty()) ? newMap() : newMap(properties, C0277JO.class.getName(), 0, 0, 0);
    }
    ...
    public static PropertyMap newMap() {
        return newMap((Class<? extends ScriptObject>) C0277JO.class);
    }
    ...
    /* loaded from: L-out.jar:jdk/nashorn/internal/runtime/PropertyMap$PropertyMapIterator.class */
