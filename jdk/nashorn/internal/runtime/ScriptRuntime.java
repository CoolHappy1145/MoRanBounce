...
/* loaded from: L-out.jar:jdk/nashorn/internal/runtime/ScriptRuntime.class */
public final class ScriptRuntime {
    ...
    static {
        ...
        ADD = CompilerConstants.staticCallNoLookup(ScriptRuntime.class, "ADD", Object.class, new Class[]{Object.class, Object.class});
        EQ_STRICT = CompilerConstants.staticCallNoLookup(ScriptRuntime.class, "EQ_STRICT", Boolean.TYPE, new Class[]{Object.class, Object.class});
        OPEN_WITH = CompilerConstants.staticCallNoLookup(ScriptRuntime.class, "openWith", ScriptObject.class, new Class[]{ScriptObject.class, Object.class});
        MERGE_SCOPE = CompilerConstants.staticCallNoLookup(ScriptRuntime.class, "mergeScope", ScriptObject.class, new Class[]{ScriptObject.class});
        TO_PROPERTY_ITERATOR = CompilerConstants.staticCallNoLookup(ScriptRuntime.class, "toPropertyIterator", Iterator.class, new Class[]{Object.class});
        TO_VALUE_ITERATOR = CompilerConstants.staticCallNoLookup(ScriptRuntime.class, "toValueIterator", Iterator.class, new Class[]{Object.class});
        APPLY = CompilerConstants.staticCall(MethodHandles.lookup(), ScriptRuntime.class, "apply", Object.class, new Class[]{ScriptFunction.class, Object.class, Object[].class});
        THROW_REFERENCE_ERROR = CompilerConstants.staticCall(MethodHandles.lookup(), ScriptRuntime.class, "throwReferenceError", Void.TYPE, new Class[]{String.class});
        THROW_CONST_TYPE_ERROR = CompilerConstants.staticCall(MethodHandles.lookup(), ScriptRuntime.class, "throwConstTypeError", Void.TYPE, new Class[]{String.class});
        INVALIDATE_RESERVED_BUILTIN_NAME = CompilerConstants.staticCallNoLookup(ScriptRuntime.class, "invalidateReservedBuiltinName", Void.TYPE, new Class[]{String.class});
    }
    ...
    public static String builtinObjectToString(Object self) {
        ...
        switch (C02362.$SwitchMap$jdk$nashorn$internal$runtime$JSType[type.ordinal()]) {
            case 1:
                className = "Boolean";
                break;
            case 2:
    ...
    /* renamed from: jdk.nashorn.internal.runtime.ScriptRuntime$2 */
    /* loaded from: L-out.jar:jdk/nashorn/internal/runtime/ScriptRuntime$2.class */
    ...
    /* loaded from: L-out.jar:jdk/nashorn/internal/runtime/ScriptRuntime$RangeIterator.class */
    ...
    public static Iterator<?> toValueIterator(Object obj) {
        ...
        if (obj != null && obj.getClass().isArray()) {
            ...
            return new Iterator(length, obj) { // from class: jdk.nashorn.internal.runtime.ScriptRuntime.1
                private int index = 0;
    ...
    public static Object TYPEOF(Object object, Object property) {
        ...
        if (property != null) {
            if (obj instanceof ScriptObject) {
                ...
                if (object == null) {
                    throw ECMAErrors.typeError("cant.get.property", new String[]{safeToString(property), Configurator.NULL});
                }
        ...
        return JSType.m12of(obj).typeName();
    }
    ...
    public static boolean DELETE(Object obj, Object property, Object strict) {
        ...
        if (obj == null) {
            throw ECMAErrors.typeError("cant.delete.property", new String[]{safeToString(property), Configurator.NULL});
        }
    ...
    public static boolean FAIL_DELETE(Object property, Object strict) {
        if (Boolean.TRUE.equals(strict)) {
            throw ECMAErrors.syntaxError("strict.cant.delete", new String[]{safeToString(property)});
        }
        return false;
    }

    /* renamed from: EQ */
    public static boolean m13EQ(Object x, Object y) {
        return equals(x, y);
    }

    /* renamed from: NE */
    public static boolean m14NE(Object x, Object y) {
        return !m13EQ(x, y);
    }
    ...
    /* renamed from: IN */
    public static boolean m15IN(Object property, Object obj) {
    ...
    /* renamed from: LT */
    public static boolean m16LT(Object x, Object y) {
    ...
    /* renamed from: GT */
    public static boolean m17GT(Object x, Object y) {
        Object px = JSType.toPrimitive(x, Number.class);
        Object py = JSType.toPrimitive(y, Number.class);
        return areBothString(px, py) ? px.toString().compareTo(py.toString()) > 0 : JSType.toNumber(px) > JSType.toNumber(py);
    }
    ...
    /* renamed from: LE */
    public static boolean m18LE(Object x, Object y) {
        Object px = JSType.toPrimitive(x, Number.class);
        Object py = JSType.toPrimitive(y, Number.class);
        return areBothString(px, py) ? px.toString().compareTo(py.toString()) <= 0 : JSType.toNumber(px) <= JSType.toNumber(py);
    }
    ...
    /* renamed from: GE */
    public static boolean m19GE(Object x, Object y) {
        Object px = JSType.toPrimitive(x, Number.class);
        Object py = JSType.toPrimitive(y, Number.class);
        return areBothString(px, py) ? px.toString().compareTo(py.toString()) >= 0 : JSType.toNumber(px) >= JSType.toNumber(py);
    }
