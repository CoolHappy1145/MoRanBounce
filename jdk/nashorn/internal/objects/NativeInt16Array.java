...
/* loaded from: L-out.jar:jdk/nashorn/internal/objects/NativeInt16Array.class */
public final class NativeInt16Array extends ArrayBufferView {
    ...
    private static final ArrayBufferView.Factory FACTORY = new ArrayBufferView.Factory(2) { // from class: jdk.nashorn.internal.objects.NativeInt16Array.1
        ...
        @Override // jdk.nashorn.internal.objects.ArrayBufferView.Factory
        public Int16ArrayData createArrayData(ByteBuffer byteBuffer, int i, int i2) {
            return new Int16ArrayData(byteBuffer.asShortBuffer(), i, i2, null);
        }
    };
    ...
    /*  JADX ERROR: NullPointerException in pass: ProcessKotlinInternals
        ...
        */
    /* loaded from: L-out.jar:jdk/nashorn/internal/objects/NativeInt16Array$Constructor.class */
    final class Constructor extends ScriptFunction {
        ...
        Constructor() {
            /*
                ...
                r-1 = r6
                jdk.nashorn.internal.objects.NativeInt16Array$Prototype r0 = new jdk.nashorn.internal.objects.NativeInt16Array$Prototype
                r1 = r0
                r1.<init>()
                r1 = r0
                r2 = r6
    ...
    /*  JADX ERROR: NullPointerException in pass: ProcessKotlinInternals
        java.lang.NullPointerException
        */
    /* loaded from: L-out.jar:jdk/nashorn/internal/objects/NativeInt16Array$Prototype.class */
    ...
    /* loaded from: L-out.jar:jdk/nashorn/internal/objects/NativeInt16Array$Int16ArrayData.class */
    private static final class Int16ArrayData extends TypedArrayData {
        private static final MethodHandle GET_ELEM = CompilerConstants.specialCall(MethodHandles.lookup(), Int16ArrayData.class, "getElem", Integer.TYPE, new Class[]{Integer.TYPE}).methodHandle();
        private static final MethodHandle SET_ELEM = CompilerConstants.specialCall(MethodHandles.lookup(), Int16ArrayData.class, "setElem", Void.TYPE, new Class[]{Integer.TYPE, Integer.TYPE}).methodHandle();

        Int16ArrayData(ShortBuffer shortBuffer, int i, int i2, C01851 c01851) {
            this(shortBuffer, i, i2);
        }

        private Int16ArrayData(ShortBuffer shortBuffer, int i, int i2) {
            super(((ShortBuffer) shortBuffer.position(i).limit(i2)).slice(), i2 - i);
        }
        ...
        private int getElem(int i) {
            try {
                return ((ShortBuffer) this.f56nb).get(i);
        ...
        private void setElem(int i, int i2) {
            try {
                if (i < ((ShortBuffer) this.f56nb).limit()) {
                    ((ShortBuffer) this.f56nb).put(i, (short) i2);
                }
            } catch (IndexOutOfBoundsException unused) {
                throw new ClassCastException();
            }
    ...
    public static NativeInt16Array constructor(boolean z, Object obj, Object[] objArr) {
        return (NativeInt16Array) constructorImpl(z, objArr, FACTORY);
    }

    NativeInt16Array(NativeArrayBuffer nativeArrayBuffer, int i, int i2) {
    ...
    protected static NativeInt16Array subarray(Object obj, Object obj2, Object obj3) {
        return (NativeInt16Array) ArrayBufferView.subarrayImpl(obj, obj2, obj3);
    }
