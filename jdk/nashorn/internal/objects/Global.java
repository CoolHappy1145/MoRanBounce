...
/*  JADX ERROR: NullPointerException in pass: ProcessKotlinInternals
    ...
    */
/* loaded from: L-out.jar:jdk/nashorn/internal/objects/Global.class */
public final class Global extends Scope {
    ...
    public volatile Object f240com;
    ...
    public volatile Object f241org;
    ...
    /*  JADX ERROR: Method load error
        jadx.core.utils.exceptions.DecodeException: Load method exception: ArrayIndexOutOfBoundsException: Index 207 out of bounds for length 202 in method: jdk.nashorn.internal.objects.Global.$clinit$():void, file: L-out.jar:jdk/nashorn/internal/objects/Global.class
    ...
    public static void $clinit$() {
        /*
        // Can't load method instructions: Load method exception: ArrayIndexOutOfBoundsException: null in method: jdk.nashorn.internal.objects.Global.$clinit$():void, file: L-out.jar:jdk/nashorn/internal/objects/Global.class
        */
    ...
    public ScriptObject newObject() {
        return useDualFields() ? new C0276JD(getObjectPrototype()) : new C0277JO(getObjectPrototype());
    }
    ...
    private static <T> T getLazilyCreatedValue(Object key, Callable<T> creator, Map<Object, T> map) throws Exception {
        T obj = map.get(key);
        if (obj != null) {
            return obj;
        }
        ...
        if (this.context.getEnv()._es6) {
            ...
            for (Property property : properties) {
                ...
                if (globalProperty != null && !globalProperty.isConfigurable() && property.isLexicalBinding()) {
                    throw ECMAErrors.syntaxError("redeclare.variable", new String[]{property.getKey()});
                }
    ...
    private void init(ScriptEngine eng) throws SecurityException {
        ...
        ScriptFunction scriptFunctionCreateBuiltin = ScriptFunction.createBuiltin("eval", EVAL);
    ...
    private <T extends ScriptObject> T initConstructor(String name, Class<T> clazz) throws ClassNotFoundException {
        try {
    ...
    private static MethodHandle findOwnMH_S(String name, Class<?> rtype, Class<?>... types) {
        return Lookup.f31MH.findStatic(MethodHandles.lookup(), Global.class, name, Lookup.f31MH.type(rtype, types));
    }
    ...
    /* loaded from: L-out.jar:jdk/nashorn/internal/objects/Global$LexicalScope.class */
    private static class LexicalScope extends ScriptObject {
        ...
        protected GuardedInvocation findGetMethod(CallSiteDescriptor callSiteDescriptor, LinkRequest linkRequest, String str) {
            return filterInvocation(super.findGetMethod(callSiteDescriptor, linkRequest, str));
        }
        ...
        @Override // jdk.nashorn.internal.runtime.ScriptObject
        protected PropertyMap addBoundProperty(PropertyMap propertyMap, ScriptObject scriptObject, Property property, boolean z) {
