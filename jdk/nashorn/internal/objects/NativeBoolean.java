...
/* loaded from: L-out.jar:jdk/nashorn/internal/objects/NativeBoolean.class */
public final class NativeBoolean extends ScriptObject {
    private final boolean value;
    static final MethodHandle WRAPFILTER = findOwnMH("wrapFilter", Lookup.f31MH.type(NativeBoolean.class, new Class[]{Object.class}));
    private static final MethodHandle PROTOFILTER = findOwnMH("protoFilter", Lookup.f31MH.type(Object.class, new Class[]{Object.class}));
    private static PropertyMap $nasgenmap$;

    /*  JADX ERROR: NullPointerException in pass: ProcessKotlinInternals
        java.lang.NullPointerException
        */
    /* loaded from: L-out.jar:jdk/nashorn/internal/objects/NativeBoolean$Constructor.class */
    ...
    /*  JADX ERROR: NullPointerException in pass: ProcessKotlinInternals
        java.lang.NullPointerException
        */
    /* loaded from: L-out.jar:jdk/nashorn/internal/objects/NativeBoolean$Prototype.class */
    ...
    private NativeBoolean(boolean z, ScriptObject scriptObject, PropertyMap propertyMap) {
        super(scriptObject, propertyMap);
        this.value = z;
    }

    NativeBoolean(boolean z, Global global) {
        this(z, global.getBooleanPrototype(), $nasgenmap$);
    }

    NativeBoolean(boolean z) {
        this(z, Global.instance());
    }
    ...
    public static boolean valueOf(Object obj) {
        return getBoolean(obj).booleanValue();
    }

    public static Object constructor(boolean z, Object obj, Object obj2) {
        boolean z2 = JSType.toBoolean(obj2);
        if (z) {
    ...
    private static Boolean getBoolean(Object obj) {
        ...
        if (obj instanceof NativeBoolean) {
            return Boolean.valueOf(((NativeBoolean) obj).getValue());
        }
        if (obj != null && obj == Global.instance().getBooleanPrototype()) {
            return false;
        }
        throw ECMAErrors.typeError("not.a.boolean", new String[]{ScriptRuntime.safeToString(obj)});
    }

    public static GuardedInvocation lookupPrimitive(LinkRequest linkRequest, Object obj) {
        return PrimitiveLookup.lookupPrimitive(linkRequest, Boolean.class, new NativeBoolean(((Boolean) obj).booleanValue()), WRAPFILTER, PROTOFILTER);
    }

    private static NativeBoolean wrapFilter(Object obj) {
        return new NativeBoolean(((Boolean) obj).booleanValue());
    }
    ...
    private static MethodHandle findOwnMH(String str, MethodType methodType) {
        return Lookup.f31MH.findStatic(MethodHandles.lookup(), NativeBoolean.class, str, methodType);
    }
}
