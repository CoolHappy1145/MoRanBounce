...
/* loaded from: L-out.jar:jdk/nashorn/internal/objects/NativeFloat64Array.class */
public final class NativeFloat64Array extends ArrayBufferView {
    ...
    private static final ArrayBufferView.Factory FACTORY = new ArrayBufferView.Factory(8) { // from class: jdk.nashorn.internal.objects.NativeFloat64Array.1
        ...
        @Override // jdk.nashorn.internal.objects.ArrayBufferView.Factory
        public Float64ArrayData createArrayData(ByteBuffer byteBuffer, int i, int i2) {
            return new Float64ArrayData(byteBuffer.asDoubleBuffer(), i, i2, null);
        }
    };
    ...
    /*  JADX ERROR: NullPointerException in pass: ProcessKotlinInternals
        ...
        */
    /* loaded from: L-out.jar:jdk/nashorn/internal/objects/NativeFloat64Array$Constructor.class */
    final class Constructor extends ScriptFunction {
        ...
        Constructor() {
            /*
                ...
                r-1 = r6
                jdk.nashorn.internal.objects.NativeFloat64Array$Prototype r0 = new jdk.nashorn.internal.objects.NativeFloat64Array$Prototype
                r1 = r0
                r1.<init>()
                r1 = r0
                r2 = r6
    ...
    /*  JADX ERROR: NullPointerException in pass: ProcessKotlinInternals
        java.lang.NullPointerException
        */
    /* loaded from: L-out.jar:jdk/nashorn/internal/objects/NativeFloat64Array$Prototype.class */
    ...
    /* loaded from: L-out.jar:jdk/nashorn/internal/objects/NativeFloat64Array$Float64ArrayData.class */
    private static final class Float64ArrayData extends TypedArrayData {
        private static final MethodHandle GET_ELEM = CompilerConstants.specialCall(MethodHandles.lookup(), Float64ArrayData.class, "getElem", Double.TYPE, new Class[]{Integer.TYPE}).methodHandle();
        private static final MethodHandle SET_ELEM = CompilerConstants.specialCall(MethodHandles.lookup(), Float64ArrayData.class, "setElem", Void.TYPE, new Class[]{Integer.TYPE, Double.TYPE}).methodHandle();

        Float64ArrayData(DoubleBuffer doubleBuffer, int i, int i2, C01841 c01841) {
            this(doubleBuffer, i, i2);
        }

        private Float64ArrayData(DoubleBuffer doubleBuffer, int i, int i2) {
            super(((DoubleBuffer) doubleBuffer.position(i).limit(i2)).slice(), i2 - i);
        }
        ...
        private double getElem(int i) {
            try {
                return ((DoubleBuffer) this.f56nb).get(i);
        ...
        private void setElem(int i, double d) {
            try {
                if (i < ((DoubleBuffer) this.f56nb).limit()) {
                    ((DoubleBuffer) this.f56nb).put(i, d);
                }
            } catch (IndexOutOfBoundsException unused) {
                throw new ClassCastException();
            }
    ...
    public static NativeFloat64Array constructor(boolean z, Object obj, Object[] objArr) {
        return (NativeFloat64Array) constructorImpl(z, objArr, FACTORY);
    }

    NativeFloat64Array(NativeArrayBuffer nativeArrayBuffer, int i, int i2) {
    ...
    protected static NativeFloat64Array subarray(Object obj, Object obj2, Object obj3) {
        return (NativeFloat64Array) ArrayBufferView.subarrayImpl(obj, obj2, obj3);
    }
