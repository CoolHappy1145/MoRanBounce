...
@Immutable
/* loaded from: L-out.jar:jdk/nashorn/internal/ir/IdentNode.class */
public final class IdentNode extends Expression implements PropertyKey, FunctionCall, Optimistic, JoinPredecessor {
    ...
    public Node accept(NodeVisitor nodeVisitor) {
        if (nodeVisitor.enterIdentNode(this)) {
            return nodeVisitor.leaveIdentNode(this);
        }
        return this;
    }
    ...
    public Optimistic setProgramPoint(int i) {
        ...
        return new IdentNode(this, this.name, this.type, this.flags, i, this.conversion);
    }
    ...
    public JoinPredecessor setLocalVariableConversion(LexicalContext lexicalContext, LocalVariableConversion localVariableConversion) {
        ...
        return new IdentNode(this, this.name, this.type, this.flags, this.programPoint, localVariableConversion);
    }
