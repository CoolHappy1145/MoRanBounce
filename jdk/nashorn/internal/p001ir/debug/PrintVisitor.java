...
/* loaded from: L-out.jar:jdk/nashorn/internal/ir/debug/PrintVisitor.class */
public final class PrintVisitor extends SimpleNodeVisitor {
    private static final int TABWIDTH = 4;

    /* renamed from: sb */
    private final StringBuilder f29sb;
    private int indent;
    ...
    public String toString() {
        return this.f29sb.append(this.EOLN).toString();
    }
    ...
    public boolean enterDefault(Node node) {
        node.toString(this.f29sb, this.printTypes);
        return false;
    }
        ...
        for (Statement statement : statements) {
            if (this.printLineNumbers) {
                ...
                if (lineNumber != this.lastLineNumber) {
                    indent();
                    this.f29sb.append("[|").append(lineNumber).append("|];").append('\n');
                }
                this.lastLineNumber = lineNumber;
            }
            indent();
            statement.accept(this);
            int lastIndex = this.f29sb.length() - 1;
            char cCharAt = this.f29sb.charAt(lastIndex);
            while (true) {
                lastChar = cCharAt;
                ...
                lastIndex--;
                cCharAt = this.f29sb.charAt(lastIndex);
            }
            if (lastChar != '}' && lastChar != ';') {
                this.f29sb.append(';');
            }
            if (statement.hasGoto()) {
                this.f29sb.append(" [GOTO]");
            }
            if (statement.isTerminal()) {
                this.f29sb.append(" [TERMINAL]");
            }
        }
        this.indent -= 4;
        this.f29sb.append(this.EOLN);
        indent();
        this.f29sb.append('}');
    ...
    public boolean enterBinaryNode(BinaryNode binaryNode) {
        ...
        this.f29sb.append(' ');
        this.f29sb.append(binaryNode.tokenType());
        this.f29sb.append(' ');
    ...
    public boolean enterIdentNode(IdentNode identNode) {
        identNode.toString(this.f29sb, this.printTypes);
        printLocalVariableConversion(identNode);
        return true;
    }

    private void printLocalVariableConversion(JoinPredecessor joinPredecessor) {
        LocalVariableConversion.toString(joinPredecessor.getLocalVariableConversion(), this.f29sb);
    }

    @Override // jdk.nashorn.internal.p001ir.visitor.NodeVisitor
    public boolean enterUnaryNode(UnaryNode unaryNode) {
        unaryNode.toString(this.f29sb, new Runnable(this, unaryNode) { // from class: jdk.nashorn.internal.ir.debug.PrintVisitor.1
            final UnaryNode val$unaryNode;
            final PrintVisitor this$0;
            ...
            public void run() {
                this.val$unaryNode.getExpression().accept(this.this$0);
            }
        }, this.printTypes);
        return false;
    }
    ...
    public boolean enterForNode(ForNode forNode) {
        forNode.toString(this.f29sb, this.printTypes);
    ...
    public boolean enterFunctionNode(FunctionNode functionNode) {
        functionNode.toString(this.f29sb, this.printTypes);
    ...
    public boolean enterIfNode(IfNode ifNode) {
        ifNode.toString(this.f29sb, this.printTypes);
        ifNode.getPass().accept(this);
        Block fail = ifNode.getFail();
        if (fail != null) {
            this.f29sb.append(" else ");
            fail.accept(this);
        }
    ...
    public boolean enterLabelNode(LabelNode labeledNode) {
        ...
        indent();
        this.indent += 4;
        labeledNode.toString(this.f29sb, this.printTypes);
    ...
    public boolean enterSplitNode(SplitNode splitNode) {
        splitNode.toString(this.f29sb, this.printTypes);
        this.f29sb.append(this.EOLN);
        this.indent += 4;
        indent();
        return true;
    ...
    public boolean enterSwitchNode(SwitchNode switchNode) {
        switchNode.toString(this.f29sb, this.printTypes);
        this.f29sb.append(" {");
        List<CaseNode> cases = switchNode.getCases();
        for (CaseNode caseNode : cases) {
            this.f29sb.append(this.EOLN);
            indent();
            caseNode.toString(this.f29sb, this.printTypes);
    ...
    public boolean enterTryNode(TryNode tryNode) {
        tryNode.toString(this.f29sb, this.printTypes);
        ...
        for (Block catchBlock : catchBlocks) {
            ...
            catchNode.toString(this.f29sb, this.printTypes);
            catchNode.getBody().accept(this);
        }
        Block finallyBody = tryNode.getFinallyBody();
        if (finallyBody != null) {
            this.f29sb.append(" finally ");
    ...
    public boolean enterVarNode(VarNode varNode) {
        this.f29sb.append(varNode.isConst() ? "const " : varNode.isLet() ? "let " : "var ");
        varNode.getName().toString(this.f29sb, this.printTypes);
    ...
    public boolean enterWhileNode(WhileNode whileNode) {
        ...
        if (whileNode.isDoWhile()) {
            this.f29sb.append("do");
            whileNode.getBody().accept(this);
            this.f29sb.append(' ');
            whileNode.toString(this.f29sb, this.printTypes);
            return false;
        }
        whileNode.toString(this.f29sb, this.printTypes);
        whileNode.getBody().accept(this);
    ...
    public boolean enterWithNode(WithNode withNode) {
        withNode.toString(this.f29sb, this.printTypes);
