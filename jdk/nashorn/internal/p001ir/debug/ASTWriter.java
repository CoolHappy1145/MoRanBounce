...
/* loaded from: L-out.jar:jdk/nashorn/internal/ir/debug/ASTWriter.class */
public final class ASTWriter {
    ...
    public Node[] toArray() throws IllegalAccessException, IllegalArgumentException {
    ...
    private void printAST(StringBuilder sb, List<Node> preorder, Field field, String name, Node node, int indent) throws IllegalAccessException, IllegalArgumentException {
        Symbol symbol;
        indent(sb, indent);
        if (node == 0) {
            sb.append("[Object ");
        ...
        String status3 = status2 + " @" + Debug.m11id(node);
        if (children.isEmpty()) {
    ...
    private static void enqueueChildren(Node node, Class<?> nodeClass, List<Field> children) throws IllegalAccessException, IllegalArgumentException {
