...
/* loaded from: L-out.jar:jdk/internal/dynalink/ChainedCallSite.class */
public class ChainedCallSite extends AbstractRelinkableCallSite {
    private static final MethodHandle PRUNE_CATCHES = MethodHandles.insertArguments(Lookup.findOwnSpecial(MethodHandles.lookup(), "prune", MethodHandle.class, new Class[]{MethodHandle.class, Boolean.TYPE}), 2, true);
    private static final MethodHandle PRUNE_SWITCHPOINTS = MethodHandles.insertArguments(Lookup.findOwnSpecial(MethodHandles.lookup(), "prune", MethodHandle.class, new Class[]{MethodHandle.class, Boolean.TYPE}), 2, false);
